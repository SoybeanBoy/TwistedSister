public class Outcomes{
  ...
  public static void terribleOutcome(){
    ...
    System.out.println("In the distance, sirens could be heard, but they did not do the common-folk’s 'WEEWOOWEEWOO', sound,");
    System.out.println("but instead made an 'R! WE’RE COMING TO SAVE YOU FROM YOUR DESPAIR' sound. R laid upon the soaked ground,");
    System.out.println("closed his eyes, and decided that tonight his bed was outside in the cold, hoping for a better tomorrow.\n");
  }
  ...
  public static void fantasticDay(){
    ...
    System.out.println("'dance the night away!', R did as his quote said, over many hills and through many fields where deer trotted by his side,");
    System.out.println("R danced until his legs gave out. The moon was shining bright. 'This is the life. I love life' said R.\n");
  }
}
